package com.nhnacademy.jdbc.board.post.respondDao;
...
public class BoardRespondDao {
    ...
    public BoardRespondDao(Long postNum, Long memberNum, String postTitle, String postContent,
